...
class App:
    def __init__(self):
        pyxel.init(160, 180, caption='Mudbone Jump Game')

        pyxel.image(0).load(1, 0, 'assets/piff.png')
        ...
        self.far_cloud = [(-10, 45), (40, 65), (90, 60)]
        self.near_cloud = [(10, 45), (30, 35), (120, 45)]
        self.floor = [(i * 40, randint(8, 104), True) for i in range(4)]
    ...
    def update(self):
        if pyxel.btnp(pyxel.KEY_Q):
            bye_msg = "You've Exited The Game!"
            pyxel.quit()
            return bye_msg
